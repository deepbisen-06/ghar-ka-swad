...
export const FOOD_IMAGES: Record<string, FoodImageMeta> = {
  hero: {
    dishId: 'hero',
    src: `${BASE}images/food/hero_thali.jpg`,
  ...
  'poha': {
    dishId: 'poha',
    src: `${BASE}images/food/dish_poha.jpg`,
  ...
  'rajma-chawal': {
    dishId: 'rajma-chawal',
    src: `${BASE}images/food/dish_rajma_chawal.jpg`,
  ...
  'khichdi': {
    dishId: 'khichdi',
    src: `${BASE}images/food/dish_khichdi.jpg`,
  ...
  'misal-pav': {
    dishId: 'misal-pav',
    src: `${BASE}images/food/dish_misal_pav.jpg`,
  ...
  'dal-tadka': {
    dishId: 'dal-tadka',
    src: `${BASE}images/food/dish_dal_tadka.jpg`,
  ...
  'idli-sambhar': {
    dishId: 'idli-sambhar',
    src: `${BASE}images/food/dish_idli_sambhar.jpg`,
  ...
  'kadhi-chawal': {
    dishId: 'kadhi-chawal',
    src: `${BASE}images/food/dish_kadhi_chawal.jpg`,
  ...
  'masala-dosa': {
    dishId: 'masala-dosa',
    src: `${BASE}images/food/dish_masala_dosa.jpg`,
